...
export default function OrphanageData() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TouchableOpacity style={styles.imagesInput} onPress={addImages}>
      ...
      <Text style={styles.label}>Hor&aacute;rio de visitas</Text>
      <TextInput
        style={styles.input}
        value={opening_hours}
      ...
      <RectButton style={styles.nextButton} onPress={() => doSubmit()}>
